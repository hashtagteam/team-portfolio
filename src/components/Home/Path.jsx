...
import { partOfWebService } from "../../../public/Service"
const Path = () => {
    ...
    <div className="flex p-16">
      <div className="w-4/5 flex flex-wrap gap-10">
        {typeOfService.map(cate =>{
          return (
            <div key={cate.id} class=" select-none block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
